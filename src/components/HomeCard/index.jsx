  ...
  return (
    <div className="global-container-home">
      <div className="btn-container-home">
        <button className="btn-filter-home" onClick={() => handleFilter("Toutes")}>
          Toutes
        </button>
        <button className="btn-filter-home" onClick={() => handleFilter("Entrées")}>
          Entrées
        </button>
        <button className="btn-filter-home" onClick={() => handleFilter("Plats")}>
          Plats
        </button>
        <button className="btn-filter-home" onClick={() => handleFilter("Desserts")}>
          Desserts
        </button>
        <button className="btn-filter-home" onClick={() => handleFilter("Boissons")}>
          Boissons
        </button>
        <button className="btn-filter-home" onClick={() => handleFilter("Autres")}>
          Autres
        </button>
      </div>
            ...
            <div key={idx} className="content-card-home">
              <Link to={`/recette/${item.id}`} className="content-img-home">
                ...
                <div>
                  ...
                  <p className="card-info-home">Ajouté par {item.authorName}, le {formattedDate}</p>
                </div>
              </Link>
            </div>
          );
